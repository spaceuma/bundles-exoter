...
Orocos.run 'navigation', 'control', 'simulation', 'unreal::Task' => 'unreal', 'path_planning::Task' => 'path_planning', 'kinova_planning::Task' => 'kinova_planning', 'coupled_control::Task' => 'coupled_control' do
    ...
    unreal.pose.connect_to                                           kinova_planning.pose_input
    unreal.goalWaypoint.connect_to                                   kinova_planning.goal_waypoint_input
    kinova_planning.goal_waypoint_output.connect_to                  path_planning.goalWaypoint
