...
# open log file
log = Orocos::Log::Replay.open('~/rock/bundles/exoter/logs/20200213-1741/loccam.0.log',
                               '~/rock/bundles/exoter/logs/20200213-1741/imu.0.log',
                               '~/rock/bundles/exoter/logs/20200213-1741/control.0.log',
                               '~/rock/bundles/exoter/logs/20200213-1741/vicon.0.log')
