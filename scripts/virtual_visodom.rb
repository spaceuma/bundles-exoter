...
log = Orocos::Log::Replay.open('~/rock/bundles/exoter/logs/20191021-1713/loccam.0.log', 
                               '~/rock/bundles/exoter/logs/20191021-1713/control.0.log', 
                               '~/rock/bundles/exoter/logs/20191021-1713/imu.0.log',
                               '~/rock/bundles/exoter/logs/20191021-1713/vicon.0.log')
