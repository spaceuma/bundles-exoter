...
# Setup tasks
Orocos::Process.run 'unit_vicon', 'unit_visual_odometry', 'navigation', 'control', 'loccam', 'stereo_vo::SpartanVO' => 'spartan' do
    ...
    Orocos.conf.apply(camera_firewire_loccam, ['exoter_bb2_b', 'manual_exposure'], :override => true)
    ...
    # Mirage server for offline testing
    # To use this you must edit the source
    # code to accomodate for the proper paths
    # to the input files!
    #mirage.configure
    #mirage.start
