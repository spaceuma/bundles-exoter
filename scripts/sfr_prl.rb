...
Orocos::Process.run 'navigation', 'autonomy', 'control', 'navcam', 'loccam', 'unit_visual_odometry', 'imu', 'unit_bb2', 'shutter_controller','path_planning::Task' => 'path_planning', 'mission_control::Task' => 'mission_control', 'coupled_control::Task' => 'coupled_control', 'vicon::Task' => 'vicon' do
    ...
    puts "Setting up mission_control"
...
#    motion_translator.motion_command.connect_to         locomotion_control.motion_command
    ...
    puts "using vicon to estimate initial pose"
